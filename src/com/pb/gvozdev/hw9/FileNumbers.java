...
public class FileNumbers {
   ...
   Path path = Paths.get("src/com/pb/gvozdev/hw9/files/numbers.txt");
    ...
    public void createOddNumbersFile() {
        ...
        Path pathOdd = Paths.get("src/com/pb/gvozdev/hw9/files/odd-numbers.txt");
